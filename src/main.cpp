            ...
            function<vector<double>( const VectorXd& )> analytical_solution = []( const VectorXd& u ) {
                ...
                return vector<double>{
                    ...
                    2 * ( 3 * x - y ) * pow( y, 2 ) * ( -9 + 3 * x + 2 * y ) *
                        ( Pi * ( 9 * pow( x, 2 ) + 3 * x * ( -9 + y ) + ( 9 - 2 * y ) * y ) * cos( 2 * Pi * x ) + 3 * ( -9 + 6 * x + y ) * sin( 2 * Pi * x ) ) *
                        sin( 2 * Pi * y ),
                    ...
                    2 * pow( y, 2 ) *
                        ( 12 * Pi * pow( -3 * x + y, 2 ) * ( -9 + 3 * x + 2 * y ) * cos( 2 * Pi * x ) +
                          12 * Pi * ( 3 * x - y ) * pow( -9 + 3 * x + 2 * y, 2 ) * cos( 2 * Pi * x ) + 9 * pow( -3 * x + y, 2 ) * sin( 2 * Pi * x ) +
                          36 * ( 3 * x - y ) * ( -9 + 3 * x + 2 * y ) * sin( 2 * Pi * x ) + 9 * pow( -9 + 3 * x + 2 * y, 2 ) * sin( 2 * Pi * x ) -
