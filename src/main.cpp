...
int main()
{
    ...
    function<vector<double>( const VectorXd& )> analytical_solution = []( const VectorXd& u ) {
        ...
        return vector<double>{
            ...
            2 * ( 3 * x - y ) * pow( y, 2 ) * ( -9 + 3 * x + 2 * y ) *
                ( Pi * ( 9 * pow( x, 2 ) + 3 * x * ( -9 + y ) + ( 9 - 2 * y ) * y ) * cos( 2 * Pi * x ) + 3 * ( -9 + 6 * x + y ) * sin( 2 * Pi * x ) ) * sin( 2 * Pi * y ),
            2 * ( 3 * x - y ) * y * ( -9 + 3 * x + 2 * y ) * sin( 2 * Pi * x ) *
                ( Pi * y * ( 9 * pow( x, 2 ) + 3 * x * ( -9 + y ) + ( 9 - 2 * y ) * y ) * cos( 2 * Pi * y ) +
                  3 * ( 3 * pow( x, 2 ) - 2 * ( -3 + y ) * y + x * ( -9 + 2 * y ) ) * sin( 2 * Pi * y ) ),
            2 * pow( y, 2 ) *
                ( 12 * Pi * pow( -3 * x + y, 2 ) * ( -9 + 3 * x + 2 * y ) * cos( 2 * Pi * x ) + 12 * Pi * ( 3 * x - y ) * pow( -9 + 3 * x + 2 * y, 2 ) * cos( 2 * Pi * x ) +
                  9 * pow( -3 * x + y, 2 ) * sin( 2 * Pi * x ) + 36 * ( 3 * x - y ) * ( -9 + 3 * x + 2 * y ) * sin( 2 * Pi * x ) +
                  9 * pow( -9 + 3 * x + 2 * y, 2 ) * sin( 2 * Pi * x ) - 2 * pow( Pi, 2 ) * pow( -3 * x + y, 2 ) * pow( -9 + 3 * x + 2 * y, 2 ) * sin( 2 * Pi * x ) ) *
                sin( 2 * Pi * y ),
            2 * y *
                ( 2 * pow( Pi, 2 ) * y * pow( -3 * x + y, 2 ) * pow( -9 + 3 * x + 2 * y, 2 ) * cos( 2 * Pi * x ) * cos( 2 * Pi * y ) +
            ...
            2 * sin( 2 * Pi * x ) *
                ( 12 * Pi * y *
                  ...
                  ( -81 * pow( x, 4 ) * ( -1 + 2 * pow( Pi, 2 ) * pow( y, 2 ) ) -
                    ...
                    2 * pow( y, 2 ) * ( 243 - 180 * y + ( 30 - 81 * pow( Pi, 2 ) ) * pow( y, 2 ) + 36 * pow( Pi, 2 ) * pow( y, 3 ) - 4 * pow( Pi, 2 ) * pow( y, 4 ) ) +
                    27 * pow( x, 2 ) * ( 27 - 6 * ( 1 + 9 * pow( Pi, 2 ) ) * pow( y, 2 ) + 2 * pow( Pi, 2 ) * pow( y, 4 ) ) +
                    6 * x * y * ( -243 + 162 * y + 2 * ( -10 + 81 * pow( Pi, 2 ) ) * pow( y, 2 ) - 54 * pow( Pi, 2 ) * pow( y, 3 ) + 4 * pow( Pi, 2 ) * pow( y, 4 ) ) ) *
                      sin( 2 * Pi * y ) )};
    };
    ...
    function<vector<double>( const VectorXd& )> body_force = []( const VectorXd& u ) {
        ...
        return vector<double>{
            -96 * Pi * cos( 2 * Pi * x ) *
                ( 2 * Pi * y * ( -108 * pow( x, 3 ) - 81 * pow( x, 2 ) * ( -6 + y ) + 18 * x * ( -27 + 2 * pow( y, 2 ) ) + y * ( 243 - 108 * y + 10 * pow( y, 2 ) ) ) *
                      cos( 2 * Pi * y ) +
                  ( 54 * pow( x, 3 ) * ( -1 + 4 * pow( Pi, 2 ) * pow( y, 2 ) ) +
                    27 * pow( x, 2 ) * ( 9 - 3 * y - 36 * pow( Pi, 2 ) * pow( y, 2 ) + 4 * pow( Pi, 2 ) * pow( y, 3 ) ) +
                    y * ( 243 + 81 * y - ( 7 + 324 * pow( Pi, 2 ) ) * pow( y, 2 ) + 108 * pow( Pi, 2 ) * pow( y, 3 ) - 8 * pow( Pi, 2 ) * pow( y, 4 ) ) -
                    9 * x * ( 27 - 12 * ( -1 + 9 * pow( Pi, 2 ) ) * pow( y, 2 ) + 4 * pow( Pi, 2 ) * pow( y, 4 ) ) ) *
                      sin( 2 * Pi * y ) ) +
            8 * sin( 2 * Pi * x ) *
                ( -12 * Pi *
                      ( 108 * pow( Pi, 2 ) * pow( x, 4 ) * y + 27 * pow( x, 3 ) * ( -1 + 4 * pow( Pi, 2 ) * ( -6 + y ) * y ) +
                        x * ( 243 + 162 * y - 3 * ( 7 + 324 * pow( Pi, 2 ) ) * pow( y, 2 ) + 432 * pow( Pi, 2 ) * pow( y, 3 ) - 40 * pow( Pi, 2 ) * pow( y, 4 ) ) +
                        y * ( -405 + 180 * y + ( -22 + 216 * pow( Pi, 2 ) ) * pow( y, 2 ) - 120 * pow( Pi, 2 ) * pow( y, 3 ) + 16 * pow( Pi, 2 ) * pow( y, 4 ) ) -
                        36 * pow( x, 2 ) * y * ( 3 + pow( Pi, 2 ) * ( -27 + 2 * pow( y, 2 ) ) ) ) *
                      cos( 2 * Pi * y ) +
                  ( 972 - 540 * y + ( 261 - 9720 * pow( Pi, 2 ) ) * pow( y, 2 ) + 2880 * pow( Pi, 2 ) * pow( y, 3 ) +
                    24 * pow( Pi, 2 ) * ( -11 + 27 * pow( Pi, 2 ) ) * pow( y, 4 ) - 288 * pow( Pi, 4 ) * pow( y, 5 ) + 32 * pow( Pi, 4 ) * pow( y, 6 ) +
                    648 * pow( Pi, 2 ) * pow( x, 4 ) * ( -1 + pow( Pi, 2 ) * pow( y, 2 ) ) +
                    432 * pow( Pi, 2 ) * pow( x, 3 ) * ( 9 - 3 * y - 9 * pow( Pi, 2 ) * pow( y, 2 ) + pow( Pi, 2 ) * pow( y, 3 ) ) -
                    6 * x *
                        ( 162 - 3 * ( 17 + 648 * pow( Pi, 2 ) ) * y - 648 * pow( Pi, 2 ) * pow( y, 2 ) +
                          8 * pow( Pi, 2 ) * ( 7 + 81 * pow( Pi, 2 ) ) * pow( y, 3 ) - 216 * pow( Pi, 4 ) * pow( y, 4 ) + 16 * pow( Pi, 4 ) * pow( y, 5 ) ) -
                    27 * pow( x, 2 ) * ( -15 + 8 * pow( Pi, 4 ) * pow( y, 2 ) * ( -27 + pow( y, 2 ) ) + 24 * pow( Pi, 2 ) * ( 9 + 4 * pow( y, 2 ) ) ) ) *
                      sin( 2 * Pi * y ) )};
    };
