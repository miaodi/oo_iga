...
int main()
{
    ...
    function<vector<double>(const VectorXd &)> analytical_solution = [](const VectorXd &u) {
        ...
        return vector<double>{pow(3 * x - y, 2) * pow(y, 2) * pow(-9 + 3 * x + 2 * y, 2) * sin(2 * Pi * x) * sin(2 * Pi * y),
                              ...
                              2 * pow(y, 2) * (12 * Pi * pow(-3 * x + y, 2) * (-9 + 3 * x + 2 * y) * cos(2 * Pi * x) + 12 * Pi * (3 * x - y) * pow(-9 + 3 * x + 2 * y, 2) * cos(2 * Pi * x) + 9 * pow(-3 * x + y, 2) * sin(2 * Pi * x) + 36 * (3 * x - y) * (-9 + 3 * x + 2 * y) * sin(2 * Pi * x) + 9 * pow(-9 + 3 * x + 2 * y, 2) * sin(2 * Pi * x) - 2 * pow(Pi, 2) * pow(-3 * x + y, 2) * pow(-9 + 3 * x + 2 * y, 2) * sin(2 * Pi * x)) * sin(2 * Pi * y),
                              2 * y * (2 * pow(Pi, 2) * y * pow(-3 * x + y, 2) * pow(-9 + 3 * x + 2 * y, 2) * cos(2 * Pi * x) * cos(2 * Pi * y) + 6 * Pi * y * pow(-3 * x + y, 2) * (-9 + 3 * x + 2 * y) * cos(2 * Pi * y) * sin(2 * Pi * x) + 6 * Pi * (3 * x - y) * y * pow(-9 + 3 * x + 2 * y, 2) * cos(2 * Pi * y) * sin(2 * Pi * x) + 4 * Pi * y * pow(-3 * x + y, 2) * (-9 + 3 * x + 2 * y) * cos(2 * Pi * x) * sin(2 * Pi * y) - 2 * Pi * (3 * x - y) * y * pow(-9 + 3 * x + 2 * y, 2) * cos(2 * Pi * x) * sin(2 * Pi * y) + 2 * Pi * pow(-3 * x + y, 2) * pow(-9 + 3 * x + 2 * y, 2) * cos(2 * Pi * x) * sin(2 * Pi * y) + 6 * y * pow(-3 * x + y, 2) * sin(2 * Pi * x) * sin(2 * Pi * y) + 6 * (3 * x - y) * y * (-9 + 3 * x + 2 * y) * sin(2 * Pi * x) * sin(2 * Pi * y) + 6 * pow(-3 * x + y, 2) * (-9 + 3 * x + 2 * y) * sin(2 * Pi * x) * sin(2 * Pi * y) + 6 * (3 * x - y) * pow(-9 + 3 * x + 2 * y, 2) * sin(2 * Pi * x) * sin(2 * Pi * y) - 3 * y * pow(-9 + 3 * x + 2 * y, 2) * sin(2 * Pi * x) * sin(2 * Pi * y)),
                              2 * sin(2 * Pi * x) * (12 * Pi * y * (27 * pow(x, 4) + 27 * pow(x, 3) * (-6 + y) + x * y * (-243 + 108 * y - 10 * pow(y, 2)) - 9 * pow(x, 2) * (-27 + 2 * pow(y, 2)) + 2 * pow(y, 2) * (27 - 15 * y + 2 * pow(y, 2))) * cos(2 * Pi * y) + (-81 * pow(x, 4) * (-1 + 2 * pow(Pi, 2) * pow(y, 2)) - 54 * pow(x, 3) * (9 - 3 * y - 18 * pow(Pi, 2) * pow(y, 2) + 2 * pow(Pi, 2) * pow(y, 3)) + 2 * pow(y, 2) * (243 - 180 * y + (30 - 81 * pow(Pi, 2)) * pow(y, 2) + 36 * pow(Pi, 2) * pow(y, 3) - 4 * pow(Pi, 2) * pow(y, 4)) + 27 * pow(x, 2) * (27 - 6 * (1 + 9 * pow(Pi, 2)) * pow(y, 2) + 2 * pow(Pi, 2) * pow(y, 4)) + 6 * x * y * (-243 + 162 * y + 2 * (-10 + 81 * pow(Pi, 2)) * pow(y, 2) - 54 * pow(Pi, 2) * pow(y, 3) + 4 * pow(Pi, 2) * pow(y, 4))) * sin(2 * Pi * y))};
    };
