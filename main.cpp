...
int main() {
    ...
    auto domain4 = make_shared<PhyTensorBsplineBasis<2, 2, double>>(a, a, points1);
    ...
    auto domain1 = make_shared<PhyTensorBsplineBasis<2, 2, double>>(a, a, points4);
