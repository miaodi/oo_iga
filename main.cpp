...
int main() {
    ...
    vector<Vector2d> points1({point1, point2, point3, point4, point5, point6, point7, point8, point9});
    ...
    vector<KnotVector<double>> solutionDomain1;
    ...
    for (int i = 0; i <= 400; i++) {
        for (int j = 0; j <= 400; j++) {
            double xi = 1.0 * i / 400, eta = 1.0 * j / 400;
            Vector2d u(xi, eta);
