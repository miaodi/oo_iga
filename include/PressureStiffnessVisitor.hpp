...
template <typename T>
class PressureStiffnessVisitor : public DomainVisitor<2, 2, T>
{
  public:
...
template <typename T>
void PressureStiffnessVisitor<T>::Initialize(Element<2, 2, T> *g)
{
...
template <typename T>
void PressureStiffnessVisitor<T>::LocalAssemble(Element<2, 2, T> *g,
...
template <typename T>
void PressureStiffnessVisitor<T>::InnerProductAssembler(Eigen::SparseMatrix<T> &sparse_matrix) const
{
...
template <typename T>
void PressureStiffnessVisitor<T>::IntegralElementAssembler(
