...
public:
    ...
    static const int Dim = TrialFunctionDimension;
...
protected:
    ...
    void LocalAssemble( Element<d, N, T>*, const QuadratureRule<T>&, const KnotSpan& );
...
void StiffnessVisitor<N, TrialFunctionDimension, T, d>::LocalAssemble( Element<d, N, T>* g,
                                                                       ...
                                                                       const KnotSpan& knot_span )
{
    ...
    std::vector<int> bilinear_form_test_indices{vector_field_index}, bilinear_form_trial_indices{vector_field_index},
        linear_form_test_indices{vector_field_index};
