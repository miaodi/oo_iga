...
template <int d, int N, typename T>
void L2StiffnessVisitor<d, N, T>::IntegralElementAssembler(
    L2StiffnessVisitor<d, N, T>::Matrix &bilinear_form_trail,
    L2StiffnessVisitor<d, N, T>::Matrix &bilinear_form_test,
    L2StiffnessVisitor<d, N, T>::Matrix &linear_form_value,
    L2StiffnessVisitor<d, N, T>::Matrix &linear_form_test,
    const L2StiffnessVisitor<d, N, T>::DomainShared_ptr domain,
    const L2StiffnessVisitor<d, N, T>::Knot &u) const
{
